...
const Contact = () => {
  return (
    <div className="w-full relative bg-dot-black/[0.1] bg-green bg-[#f4f4f4] pt-[160px] pb-[240px] ">
      <section id="contact-us" className="pt-[80px]">
        <div className=" flex w-full max-w-[1216px] px-[64px] flex-col flex-nowrap justify-start items-center mx-auto">
          ...
          <motion.div
            ...
            whileInView="show"
            viewport={{ once: true, amount: 0.1 }}
            className="w-full gap-[24px] row-auto grid grid-cols-2"
          >
                ...
                <form className="flex flex-col flex-nowrap gap-[32px] ">
                  <div className="flex flex-col flex-nowrap gap-[12px] ">
                    <input
                      ...
                      className="outline-none h-[60px] mb-0 bg-[#f4f4f4] py-[20px] px-[24px] border-solid border-[1px] border-[#eee] rounded-[16px] leading-[132%] font-[400] text-[#1b1b1b]"
                    />
                    <input
                      aria-required
                      id="email"
                    ...
                    <textarea
                      ...
                      className=" outline-none h-auto min-h-[144px] mb-0 py-[20px] px-[24px] border-solid border-[1px] rounded-[16px] bg-[#f4f4f4] font-[400] leading-[132%] border-[#eee] text-[#1b1b1b] "
                    ></textarea>
                  </div>
                  <button
                    title="button"
                    type="submit"
                    className="flex py-[20px] px-[32px] justify-center items-center gap-[10px] rounded-[100px] text-center border-solid border-[1px] border-[#1b1b1b] bg-[#1b1b1b] text-white shadow-[rgba(27,27,27,0.25)_0px_6px_12px_0px] hover:bg-neutral-700 duration-300 transition-all hover:border-neutral-700"
                  >
                    Send a Message
                  </button>
                </form>
              ...
              <div className="relative z-[2] flex flex-col flex-nowrap justify-between items-start flex-1 gap-[24px]  ">
                <div className="flex w-full flex-col flex-nowrap justify-start items-start gap-[24px]">
                  ...
                  <ReuseableButton
                    text={"Book a Call"}
                    className={
                      "px-[32px] py-[20px] text-black  bg-[#fbfbfb] gap-2 flex ease-linear"
                    }
                    icon={true}
                  />
                </div>
